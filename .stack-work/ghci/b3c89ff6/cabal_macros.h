...
/* package Baesich-1.0 */
#ifndef VERSION_Baesich
#define VERSION_Baesich "1.0"
#endif /* VERSION_Baesich */
#ifndef MIN_VERSION_Baesich
#define MIN_VERSION_Baesich(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_Baesich */
...
#define CURRENT_COMPONENT_ID "Baesich-1.0-1UysXSiRHFk42vYcSzB8JZ-Baesich"
